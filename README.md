...
```html
<!-- Brand: Icon Font -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/tlezotte/brand-icons@0/style.min.css">
```

```html
<!-- Brand: SVG Sprite -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/tlezotte/brand-icons@0/sprite/sprite.min.css">
```

```html
<!-- Brand: Images in PDF, PNG and SVG format -->
<img src="https://cdn.jsdelivr.net/gh/tlezotte/brand-icons@0/img/PNG/apache.png">
```
...
CDN Details: [jsdelivr](https://www.jsdelivr.com/package/gh/tlezotte/brand-icons)
